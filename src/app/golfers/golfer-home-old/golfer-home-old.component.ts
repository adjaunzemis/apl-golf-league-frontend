...
@Component({
  selector: 'app-golfer-home-old',
  templateUrl: './golfer-home-old.component.html',
  styleUrls: ['./golfer-home-old.component.css'],
  standalone: false,
})
export class GolferHomeOldComponent implements OnInit, OnDestroy {
