...
@Component({
  selector: 'app-tournament-team-create',
...
export class TournamentTeamCreateComponent implements OnInit, OnChanges {
  ...
  @Input() divisionOptions: TournamentDivision[];
  private divisionNameToId: Record<string, number> = {};

  @Input() initialTeam: TournamentTeam | null;
  teamId: number | null = null;
  teamGolfers: TournamentTeamGolfer[] = [];

  teamName: string;

  newGolfer: Golfer | null = null;
  newGolferRole: string | undefined;
  newGolferDivision: TournamentDivision | null = null;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes['golferOptions'] || changes['tournamentId']) {
      this.clear();
    }
    ...
    if (changes['initialTeam']) {
      ...
      if (changes['initialTeam'].currentValue !== null) {
        this.refreshFromTeam(changes['initialTeam'].currentValue as TournamentTeam);
      }
    }
  }
  ...
  private refreshFromTeam(team: TournamentTeam): void {
  ...
  removeGolferFromTeam(golfer: TournamentTeamGolfer): void {
