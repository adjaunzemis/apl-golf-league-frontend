...
export class RoundListComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  columnsToDisplay = ['date_played', 'golfer_name', 'golfer_handicap_index', 'golfer_playing_handicap', 'gross_score', 'course_name', 'tee_name', 'tee_gender', 'tee_par', 'tee_rating', 'tee_slope', 'tee_color'];
